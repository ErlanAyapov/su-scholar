# Generated by Django 6.0.3 on 2026-03-05 10:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('university', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departments', to='account.university')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('universities', models.ManyToManyField(blank=True, related_name='users', to='account.university')),
            ],
            options={
                'verbose_name': 'user',
